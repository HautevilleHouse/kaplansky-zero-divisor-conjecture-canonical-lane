# Constant Extraction Spec (KZD)
    ...
    ## Formula Set
    - `kappa_support_raw = c_support_raw * support_density_raw - e_support_raw`
- `sigma_cancellation_raw = cancellation_floor_raw - support_loss_raw - restart_loss_raw`
- `kappa_compact_raw = 1.0 / (1.0 + delta_comp_sup_raw)`
- `rho_rigidity_raw = rho_rigidity_raw`
- `domain_transfer_raw = c_domain_raw * transfer_gain_raw - e_domain_raw`
- `eps_coh_raw = eps_coh_raw`
- `sigma_star_can_raw = sigma_star_can_raw`

    ## Validations
    - positivity required for: `kappa_support`, `sigma_cancellation`, `kappa_compact`, `rho_rigidity`, `domain_transfer`, `sigma_star_can`
    ...
    3. `scripts/kzd_closure_guard.py`
