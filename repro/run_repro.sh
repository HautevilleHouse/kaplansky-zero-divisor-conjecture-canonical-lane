...
mkdir -p .tmp/kaplansky_zero_divisor_conjecture
cp artifacts/stitch_constants.json .tmp/kaplansky_zero_divisor_conjecture/stitch_constants.json
cp artifacts/constants_registry.json .tmp/kaplansky_zero_divisor_conjecture/constants_registry.json
