...
Canonical Lane research workspace for a flagship problem in algebra and group-ring theory:
proving zero-divisor exclusion for torsion-free group rings through an admissible support-persistence closure architecture.

## Main Manuscript

- [paper/KAPLANSKY_ZERO_DIVISOR_CONJECTURE_PREPRINT.md](paper/KAPLANSKY_ZERO_DIVISOR_CONJECTURE_PREPRINT.md)
- [paper/CANONICAL_ROUTING_INDEX.md](paper/CANONICAL_ROUTING_INDEX.md)

## Structure

- `paper/`
  - `KAPLANSKY_ZERO_DIVISOR_CONJECTURE_PREPRINT.md`
...
1. Theorem chain first: read `paper/KAPLANSKY_ZERO_DIVISOR_CONJECTURE_PREPRINT.md`.
...
Current KZD runner policy:

- `repro/run_repro.sh` extracts, promotes, runs `scripts/kzd_closure_guard.py`, updates `repro/repro_manifest.json`, and enforces `fully_extracted` release-gate mode.
...
3. artifact key consumed by `scripts/kzd_closure_guard.py`.
...
- Manuscript target: [paper/KAPLANSKY_ZERO_DIVISOR_CONJECTURE_PREPRINT.md](paper/KAPLANSKY_ZERO_DIVISOR_CONJECTURE_PREPRINT.md)
